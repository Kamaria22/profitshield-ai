...
function LayoutContent({ children, currentPageName, resolver = {} }) {
  ...
  const showDesktopStorePanel = isAdmin;
  const showDesktopUserMenu = isAdmin;
    ...
    >
      ...
      `}>
        <div className="relative flex h-full w-full flex-col">
          ...
          {showDesktopStorePanel && isResolved && storeDisplayName ? (
          ...
          ) : showDesktopStorePanel && !isResolved && (
            <div className="px-4 py-3 border-b border-white/8">
          ...
          {/* User Menu */}
          {showDesktopUserMenu && activeUser && (
      ...
      <div className="relative isolate min-h-screen flex flex-col overflow-x-hidden lg:ml-64">
        ...
        >
          <MobileDeepWrapper>
          <div className="page-canvas relative z-[1] -mt-7 px-2 pb-0.5 pt-0 sm:px-2.5 sm:pb-1 sm:pt-0 lg:px-3 lg:pb-1 lg:pt-0">
            ...
            <div className="space-y-1">
              <div className="-mx-2 -mt-1 sm:-mx-2.5 lg:-mx-3">
